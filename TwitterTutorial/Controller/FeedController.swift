...
class FeedController: UICollectionViewController {
    ...
    func configUI() {
        ...
        let refresehControl = UIRefreshControl()
        refresehControl.addTarget(self, action: #selector(handleRefresh), for: .valueChanged)
        collectionView.refreshControl = refresehControl
